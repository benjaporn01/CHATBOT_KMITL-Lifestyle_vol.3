...
var wit = require('botkit-witai')({
  accessToken : 'EMHECK4HIIBOTMCQAACS2TTKLUMUWPI4',
  minConfidence: 0.6,
  logLevel: 'debug'
});
facebookController.middleware.receive.use(wit.receive);
// -----------------------------------------------------------------------------WIT AI-------------------------
...
facebookController.hears(['spa'], 'message_received', wit.hears, function (bot, message) {
    facebookBot.reply("Wit.ai detected entities", message.entities);
})
